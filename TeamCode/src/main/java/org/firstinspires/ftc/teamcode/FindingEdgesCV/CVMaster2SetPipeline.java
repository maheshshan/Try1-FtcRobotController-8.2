...
public class CVMaster2SetPipeline {
    private OpenCvWebcam webcam;

    private MultiColorFilter opencv = null;
    private LinearOpMode op;
    public CVMaster2SetPipeline(LinearOpMode p_op){
    ...
    public void putImageChannel(ImageChannels channel1){
        opencv.putImageChannel(channel1);
    }
    public ImageChannels getImageChannel(){
        return opencv.getImageChannel();
     }
    //stop streaming
